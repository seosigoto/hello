...
import SeosigotoHelloSeosigotoHelloHello from './seosigoto/hello/seosigoto.hello.hello'
...
export default { 
  ...
  SeosigotoHelloSeosigotoHelloHello: load(SeosigotoHelloSeosigotoHelloHello, 'seosigoto.hello.hello'),
